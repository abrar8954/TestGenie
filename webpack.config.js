...
/** @type WebpackConfig */
const webviewConfig = {
  target: 'web', // The webview runs in a browser-like environment
  mode: 'production', // Use 'production' mode for optimized output

  entry: './src/webview/index.tsx', // The entry point for the React app
  output: {
    path: path.resolve(__dirname, 'out'),
    filename: 'webview.js', // Bundle for the webview
  },
  resolve: {
